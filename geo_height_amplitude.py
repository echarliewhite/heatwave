"""
File: geo_height_amplitude.py
Author: Charlie White
Email: charlie.white@mail.utoronto.ca
Github: echarliewhite
Description: This script compares the time evolution of amplitude of total,
standing, and travelling wave anomalies in time periods surrounding heat waves.
"""
import numpy as np
